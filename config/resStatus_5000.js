module.exports = {
    ...
    DATE_WEIRD : { "isSuccess": false, "code": 5002, "message": "시작날짜보다 마지막날짜가 앞서 있습니다." },
    
    
    //user
    USER_OAUTH_SIGNUP_REDUNDANT_EMAIL : {"isSuccess" : false, "code" : 5100, "message" : "해당 이메일을 가진 회원은 이미 등록되어 있습니다. 소셜로그인을 진행해주세요."},
